    ...
    const faq = [
      {
        id: "collapseOne",
        headerId: "headingOne",
        question: "What is Param Solutions?",
        answer:
          "Param Solutions is an integrated technology development studio that partners with organizations to deliver innovative digital solutions. We combine expert technical leadership with agile development methodologies to accelerate your business growth.",
      },
      {
        id: "collapseTwo",
        headerId: "headingTwo",
        ...
        answer:
          ...
          "- Fractional CTO & Fractional Engineer: On-demand executive-level tech leadership and engineering expertise without full-time overhead.\n" +
          "- Software Development: Custom full-stack development tailored to your business needs.\n" +
          "- DevOps & Cloud Services: Optimizing operations with modern cloud infrastructure, including AWS best practices.\n" +
          "- Machine Learning & AI: Advanced solutions to harness the power of data.\n" +
          "- Staff Augmentation & Agile Teams: Flexible, scalable teams to rapidly execute projects.\n" +
          "- MVP Development: Rapid prototyping to bring your ideas to market faster.",
      },
      {
        id: "collapseThree",
        headerId: "headingThree",
        question: "How does your Fractional CTO/Engineer service work?",
        answer:
          "We provide part-time technical leadership and engineering support tailored to your project's scope and budget. This model allows startups and enterprises to benefit from seasoned expertise and strategic guidance without the commitment of a full-time hire.",
      },
      {
        id: "collapseFour",
        ...
        answer:
          "We work with a wide range of industries—including finance, healthcare, retail, and emerging startups—to deliver solutions that drive digital transformation and efficiency.",
      },
      {
        id: "collapseFive",
        ...
        answer:
          "Our team leverages modern frameworks and platforms for software development, cloud computing (especially AWS), DevOps automation, and machine learning. This ensures that your solution is scalable, secure, and future-proof.",
      },
      {
        id: "collapseSix",
        headerId: "headingSix",
        ...
        answer:
          "Simply reach out via our contact page, email, or phone. We’ll schedule a consultation to understand your needs and discuss how our tailored solutions can help achieve your goals.",
      },
      {
        id: "collapseSeven",
        headerId: "headingSeven",
        question: "What are the benefits of working with Param Solutions?",
        answer:
          "By partnering with us, you gain:\n\n" +
          "- Access to top-tier tech leadership and expert development teams.\n" +
          "- Flexible engagement models tailored to your project size and budget.\n" +
          "- Faster time-to-market for innovative solutions.\n" +
          "- Reduced delivery risk with proven agile methodologies.\n" +
          "- Comprehensive post-launch support to ensure continued success.",
      },
      {
        id: "collapseEight",
        ...
        answer:
          "Yes, we provide ongoing support and maintenance, ensuring your digital solution remains optimized, secure, and up-to-date as your business evolves.",
      },
      {
        id: "collapseNine",
        ...
        answer:
          "We have a strong presence in Africa—with operations in South Africa, Ghana, Kenya, among others—and collaborate with clients globally to deliver world-class technology solutions.",
      },
      {
        id: "collapseTen",
        headerId: "headingTen",
        question: "Can I see examples of your work or client testimonials?",
        answer:
          "Absolutely. Please visit our 'Blog' and 'Testimonials' sections on our website for case studies and client success stories.",
      },
    ];
